...
{
public:
	static FStepListenerToAppleARKit* CreateRemoteListener();

	FStepListenerToAppleARKit();
	virtual ~FStepListenerToAppleARKit();
	...
	{
		RETURN_QUICK_DECLARE_CYCLE_STAT(FStepListenerToAppleARKit, STATGROUP_Tickables);
	}
